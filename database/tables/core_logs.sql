CREATE TABLE IF NOT EXISTS core_logs (
    ...
    followup_result                 VARCHAR2(16),
    followup_timer                  VARCHAR2(8),
...
COMMENT ON COLUMN core_logs.flag                IS 'Type of error';
...
COMMENT ON COLUMN core_logs.followup_result     IS '';
COMMENT ON COLUMN core_logs.followup_timer      IS '';
